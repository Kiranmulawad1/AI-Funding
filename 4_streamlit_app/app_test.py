...
for key in [
    ...
    "pdf_hash", "search_method", "ask_clarifying_questions",
    "current_funding_questions", "current_draft_questions", 
    "waiting_for_clarification", "last_results", "show_draft_questions", 
    "follow_up_responses", "current_follow_up", "processed_original_query"
]:
...
if st.sidebar.button("🆕 Reset Chat", type="secondary", use_container_width=True):
    for key in [
    "chat_history", "last_recommendation", "pdf_summary_query",
    "pdf_hash", "waiting_for_clarification", "show_draft_questions", 
    "follow_up_responses", "current_follow_up", "current_funding_questions", 
    "original_query", "processed_original_query", "pdf_processed"
    ]:
